...
namespace ResurseSystem
{
    ...
    public class GlobalResurseStock :ScriptableObject
    {
        ...
        {
            GlobalResursesStock =resurseStock;
            AllResursesStockPlayer = new List<ResurseStock>();
        }
        public GlobalResurseStock(GlobalResurseStock globalResurseStock)
        {
            GlobalResursesStock = globalResurseStock.GlobalResursesStock;
            AllResursesStockPlayer = globalResurseStock.AllResursesStockPlayer;
        }
        ...
        public IResurseStock GetGlobalResurseStock()
        {
